                ...
                <div class="card text-black bg-default o-hidden h-100">
                    <form action="#" id="stress_form">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-10 col-form-label">1. I can't honestly say what I really think or get things of my chest at work</label>
                            <div class="col-2">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-10 col-form-label">4. I seldom recieve adequate acknoledgement or appreciation when my work is really good</label>
                            <div class="col-2">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-10 col-form-label">6. I have the impression that I am repeatedly picked on or discreminated against work</label>
                            <div class="col-2">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-10 col-form-label">8. My job often interferes with my family and social pbligations,or personal needs</label>
                            <div class="col-2">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-10 col-form-label">9. I tend to have frequent argument with superier,or corwarkers or customers</label>
                            <div class="col-2">
